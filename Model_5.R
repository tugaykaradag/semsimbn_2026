...
# Structural model (Model5: C->A, C->E, C->B, B->E, E->D, D->A)
B ~ 0.6*C
E ~ 0.6*C + 0.4*B
D ~ 0.6*E
A ~ 0.6*C + 0.4*D
...
# (Optional) indicator residual variances (loading=0.8 => residual var=0.36)
A1 ~~ 0.36*A1
A2 ~~ 0.36*A2
A3 ~~ 0.36*A3
B1 ~~ 0.36*B1
...
# Structural model (free regressions) - Model5
B ~ C
E ~ C + B
D ~ E
A ~ C + D
...
final_table_200
library(writexl)
write_xlsx(final_table_200,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_5_final_table_200.xlsx")
...
final_table_500
library(writexl)
write_xlsx(final_table_500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_5_final_table_500.xlsx")
}
#1000 icin
{
model_pop <- '
...
final_table_1000
library(writexl)
write_xlsx(final_table_1000,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_5_final_table_1000.xlsx")
}
#2500 icin
{
model_pop <- '
...
final_table_2500
library(writexl)
write_xlsx(final_table_2500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_5_final_table_2500.xlsx")
