...
# Structural model (Model2: D->B, D->C, D->E, E->C, C->B)
E ~ 0.6*D
C ~ 0.6*D + 0.4*E
B ~ 0.6*D + 0.4*C
...
# (Optional) indicator residual variances (since loading=0.8 => residual var=1-0.8^2=0.36)
B1 ~~ 0.36*B1
B2 ~~ 0.36*B2
B3 ~~ 0.36*B3
C1 ~~ 0.36*C1
...
# Structural model (free regressions) - Model2
E ~ D
C ~ D + E
B ~ D + C
'
  ...
  all_edges <- all_edges[!grepl("(B B|C C|D D|E E)", all_edges)]
  ...
  final_table_200
  library(writexl)
  write_xlsx(final_table_200,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_2_final_table_200.xlsx")
...
final_table_500
library(writexl)
write_xlsx(final_table_500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_2_final_table_500.xlsx")
...
final_table_1000
library(writexl)
write_xlsx(final_table_1000,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_2_final_table_1000.xlsx")
...
final_table_2500
library(writexl)
write_xlsx(final_table_2500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_2_final_table_2500.xlsx")
