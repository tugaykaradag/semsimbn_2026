...
# (Optional) indicator residual variances
A1 ~~ 0.36*A1
A2 ~~ 0.36*A2
A3 ~~ 0.36*A3
B1 ~~ 0.36*B1
...
# Structural model (free regressions)
A ~ B
C ~ A
E ~ C + B
D ~ E
...
final_table_200
library(writexl)
write_xlsx(final_table_200,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_1_final_table_200.xlsx")
}
#500 icin
{
  #gozlem sayisini degistir sadece
...
'
  ...
  final_table_500
  library(writexl)
  write_xlsx(final_table_500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_1_final_table_500.xlsx")
}
#1000 icin
{
  #gozlem sayisini degistir sadece
...
'
  ...
  final_table_1000
  library(writexl)
  write_xlsx(final_table_1000,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_1_final_table_1000.xlsx")
}
#2500 icin
{
  #gozlem sayisini degistir sadece
...
'
  ...
  final_table_2500
  library(writexl)
  write_xlsx(final_table_2500,"D:/Makaleler/SEM Simulasyon/Revs/Rev13 Array/Added Analyses/model_1_final_table_2500.xlsx")
}
library(beepr)
beep(sound = 8)
